...
const translations: Translations = {
  ...
  "hero.title": { en: "Full Stack Developer • Shopify Developer", es: "Desarrollador Full Stack • Desarrollador Shopify" },
  "hero.description": {
  ...
  "project.1.title": { en: "E-Commerce Stores 1530", es: "E-Commerce Tiendas 1530" },
  ...
  "project.2.title": { en: "Ecommerce Osiris Shoes", es: "Ecommerce Osiris Shoes" },
  ...
  "project.3.title": { en: "Ecommerce Tododeportes", es: "Ecommerce Tododeportes" },
  "project.3.description": {
   ...
   "project.4.title": { en: "Ecommerce Titansportswear", es: "Ecommerce Titansportswear" },
  ...
  "education.subtitle": { en: "My academic journey", es: "Mi trayectoria academica" },

  "edu.1.degree": { en: "Civil Mechatronics Engineering", es: "Ingeniería Civil Mecatrónica" },
  ...
  "edu.2.degree": { en: "Full Stack Developer", es: "Desarrollador Full Stack" },
  "edu.2.school": { en: "Soy Henry Bootcamp", es: "Soy Henry Bootcamp" },
  "edu.2.year": { en: "2023 - 2023", es: "2023 - 2023" },
  "edu.2.description": {
    en: "Graduated with honors. Focus on web technologies, distributed systems, and software architecture. Led multiple student projects.",
    es: "Graduado con honores. Enfoque en tecnologias web, sistemas distribuidos y arquitectura de software. Lidere multiples proyectos estudiantiles.",
  },

  "edu.3.degree": { en: "Computer Engineering", es: "Ingeniería Informática" },
  "edu.3.school": { en: "San Sebastian University", es: "Universidad San Sebastian" },
  ...
  "edu.4.degree": { en: "Vocational Training", es: "Formación Profesional" },
  "edu.4.school": { en: "Web development and programming – Udemy, Coderhouse, IBM", es: "Desarrollo web y programación – Udemy, Coderhouse, IBM" },
  "edu.4.year": { en: "2017 - 2026", es: "2017 - 2026" },
  "edu.4.description": {
  ...
  "contact.form.email.placeholder": { en: "your@email.com", es: "tu@correo.com" },
  "contact.form.message": { en: "Message", es: "Mensaje" },
  "contact.form.message.placeholder": { en: "Tell me about your project...", es: "Cuentame sobre tu proyecto..." },
  "contact.form.submit": { en: "Send Message", es: "Enviar Mensaje" },
  "contact.form.sending": { en: "Sending...", es: "Enviando..." },
  "contact.form.success": { en: "Message sent successfully!", es: "Mensaje enviado con exito!" },
  "contact.form.error": { en: "Failed to send message. Please try again.", es: "Error al enviar el mensaje. Por favor, intenta de nuevo." },
